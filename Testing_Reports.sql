...
SELECT DISTINCT 
                         GETDATE() AS Expr1, dbo.fnc_FiscalYear(@fiscalyear) AS FiscalYear, P.ProjectName, P.[Project Status], P.[Project Stage], P.ProjectStartDate, 
                         ...
                         P.ProjectOwnerResourceUID, P.Program, ISNULL(P.[Organization and Alignment], 'z_NA') AS [Organization and Alignment]
