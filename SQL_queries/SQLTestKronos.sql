...
SELECT dbo.myUnion_Encoder_ID.Encoder_ID
	  ...
	  , dbo.Kronos3MTime.[Reg-1]
	  , dbo.Kronos3MTime.[Reg-2]
	  , dbo.Kronos3MTime.[OT_Hours]
...
LEFT JOIN dbo.Kronos3MTime
ON ['Position_Staff - Coder$'].EE# = dbo.Kronos3MTime.PERSONNUM

DROP Table dbo.Productivity_prevDay --dbo.Productivity_PrevPayPeriod
GO
...
SELECT dbo.myUnion_Encoder_ID.Encoder_ID
	  ...
	  , dbo.Kronos3MTime.[Reg-2]
	  , dbo.Kronos3MTime.[OT_Hours]
INTO dbo.Productivity_prevDay--dbo.Productivity_PrevPayPeriod 
FROM dbo.myUnion_Encoder_ID
LEFT JOIN ['Position_Staff - Coder$']
ON dbo.myUnion_Encoder_ID.Encoder_ID = ['Position_Staff - Coder$'].enc_ID
LEFT JOIN dbo.SoftMed_Tbl_PrevPayPeriod
...
DROP Table dbo.SoftMed_OutPatientCoders_Only_Previous_Day--dbo.SoftMed_PrevPayPeriod_OPC
GO
...
SELECT dbo.OutPatient_Encoder_ID.Encoder_ID
	  ...
	  , dbo.Kronos3MTime.[Reg-2]
	  , dbo.Kronos3MTime.[OT_Hours]
INTO dbo.SoftMed_OutPatientCoders_Only_Previous_Day--dbo.SoftMed_PrevPayPeriod_OPC
