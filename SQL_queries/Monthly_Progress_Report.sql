SELECT    visit_view.discharged
		...
		, ctc_encoderresults_view.enc_code_id AS Encoded_By
		, visit_view.bill_no
		, visit_view.mrn
...
WHERE     (ctc_encoderresults_view.enc_code_dt_tm >= DATEADD(MONTH,DATEDIFF(MONTH, '20000101', CURRENT_TIMESTAMP),'20000101')) 
		AND (ctc_encoderresults_view.enc_code_dt_tm <= CONVERT(date, GETDATE()))
order by [ctc_encoderresults_init_view].[enc_code_dt_tm] desc